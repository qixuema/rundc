...
# 暂时添加一个 for 循环，每 100 帧重建一次
for ii in range(0, 100):
    # 修改输入文件路径及名称    
    # FLAGS.test_input = "examples/gt_100_scans_07_kitti-odometry_range_30_start_" + str(ii*100) + ".ply" # kitti
    # FLAGS.test_input = "/studio/project/puma_ma/puma/apps/data/ncd/quad/batch/gt_100_scans_01_quad_start_" + str(ii*100) + ".ply" # ncd
    FLAGS.test_input = "/studio/project/puma_ma/puma/apps/data/mai_city/ply/sequences/01/velodyne/" + str(ii).zfill(6) + ".ply" # kitti
    
    print(FLAGS.test_input)
